                                            ...
                                            <form id="validationform" name="student_form" data-parsley-validate="" novalidate="" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <input data-parsley-type="alphanum" type="text"  id="LRNInput" name="LRN" value="LRN-" required="" placeholder="LRN" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                               ...
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                       <select data-parsley-type="alphanum" type="text" id="course" required="" placeholder="" class="form-control">
                                                        <?php 
                                                            ...
                                                            $conn = new class_model();
                                                            $STRAND = $conn->user_account($user_id);
                                                            $strandValue = $STRAND['STRAND'];
                                                            ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                    <select id="year_level" required="" placeholder=" " class="form-control">
    ...
    <script>
      $(document).ready(function() {
       $('form[name="student_form"]').on('submit', function(e){
          ...
          var m = $(this).find('input[name="LRN"]').val();
          var n = $(this).find('input[name="Password"]').val();
