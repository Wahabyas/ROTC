                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="student_form" data-parsley-validate="" novalidate="" method="POST">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Graduate?</label>
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                       <select data-parsley-type="alphanum" type="text" value="<?= $Graduate; ?>" name="Graduate" required="" placeholder="" class="form-control">
                                                           <option value="<?= $Graduate; ?>" hidden><?=$Graduate; ?></option>
                                                           <option value="Graduated <?=$previousYear?>-<?=$currentYear?>" style="background-color: green;color: #fff">Graduate <?=$previousYear?>-<?=$currentYear?></option>
                                                           <option value="" style="background-color: red;color: #fff">Not yet</option>
                                                       </select>
                                                    </div>
                                                </div>
                                                </div>
    ...
    <script>
      $(document).ready(function() {
       $('form[name="student_form"]').on('submit', function(e){
          ...
          var n = $(this).find('select[name="Graduate"]').val();
