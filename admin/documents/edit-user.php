       <?php include('main_header/header.php');?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="validationform" name="user_form" data-parsley-validate="" novalidate="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-12 col-sm-8 col-lg-6">
                                                        <select data-parsley-type="alphanum" type="text" name="Role2" required="" placeholder="" class="form-control">
                                                        <option value="<?=$row['role']?>"> <?=$row['role'] == 'CHAIRPERSON' ? 'officer' : 'Admin'; ?> </option>    
        ...
        <div class="col-12 col-sm-8 col-lg-6">
            <input data-parsley-type="alphanum" type="text" value="<?= $row['password']; ?>" name="password2" required="" placeholder="" class="form-control">
        </div>
                                                        </div>
                                                 <div class="form-group row">
        ...
        <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
            ...
            <button class="btn btn-space btn-primary" id="edit-user" type="button">Submit</button>
        </div>
    </div>
                                            </form>
                                        </div>
    ...
    <script>
       document.addEventListener('DOMContentLoaded', function () {
            ...
            btn.addEventListener('click', function () {
                ...
                data.append('status2', status);
                data.append('user_id', user_id);

                if (complete_name === '' && desgination === '' &&  email_address === '' && phone_number === '' && username === '' &&  password === '' && STRAND === '' && Role==='' &&  status ==='') {
