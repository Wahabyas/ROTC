                        ...
                        <div class="card">
                            <div class="card-body">
                               <?php 
                                    ...
                                    $countStdbyACTIVATE=$conn->count_numberofstudentbyACTIVATED();
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h5 class="text-muted">Name of Admin</h5>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <?php foreach ($countStdbyACTIVATE as $row): ?>
                                <div class="d-inline-block">
                                    <h5 class="text-muted">Active Student</h5>
                                    <h2 class="mb-0"><?= $row['count_students']; ?></h2>
                                </div>
                                <div class="float-right icon-circle-medium  icon-box-lg  bg-info-light mt-1">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                               ...
                               <?php foreach ($countStdbyDEACTIVATE as $row): ?>
                                <div class="d-inline-block">
                                    <h5 class="text-muted">Deacivated Student</h5>
                                    <h2 class="mb-0"><?= $row['count_students']; ?></h2>
                                </div>
                                <div class="float-right icon-circle-medium  icon-box-lg  bg-info-light mt-1">
                        ...
                        <div class="card">
                            <div class="card-body">
                              <?php 
                                    ...
                                    $COUNTteahcers = $conn->count_numberofTEACHERS();
                                   
                               ?>
                               <?php foreach ($COUNTteahcers as $row): ?>
                                <div class="d-inline-block">
                                    <h5 class="text-muted">Number of Officer</h5>
                                    <h2 class="mb-0"><?= $row['count_students']; ?></h2>
                                </div>
                                <div class="float-right icon-circle-medium  icon-box-lg  bg-info-light mt-1">
                                <i class="fa fa-chalkboard-teacher fa-fw fa-sm text-info"></i>
                                </div>
                                 <?php endforeach;?>
                            </div>
                        </div>
