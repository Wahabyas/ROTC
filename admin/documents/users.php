        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="add-user.php" class="btn btn-sm" style="background-color:rgb(235, 151, 42) !important; color: rgb(243, 245, 238) !important;"><i class="fa fa-fw fa-user-plus"></i> Add User</a><br><br>
                    <table class="table table-striped table-bordered first">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Platoon Officer</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($user as $row) { ?>
                                <tr>
                                    ...
                                    <td><?= $row['desgination']; ?></td> <!-- Corrected the field name here -->
                                    <td><?= $row['email_address']; ?></td>
                                    <td><?= $row['phone_number']; ?></td>
                                    <td><?= $row['STRAND']; ?></td>
                                    <td><?= $row['Section']; ?></td>
                                    <td><?= $row['role'] == 'CHAIRPERSON' ? 'Officer' : 'Admin'; ?></td>
                                    <td>
                                        <?php 
