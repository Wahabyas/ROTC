...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($studentIds as $studentId) {
        ...
        $updateQuery = "UPDATE tbl_student SET account_status = '$newYearLevel' WHERE student_id = '$studentId'";
	...
	echo '<div class="alert alert-success">Action Success</div><script> setTimeout(function() {  window.history.go(-1); }, 1000); </script>';
