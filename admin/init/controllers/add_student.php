<?php
 ...
 $IDNumber ='PASS-'.createRandomIDnumber();
	...
	if(ISSET($_POST)){
		...
		$course = $conn->add_student( $first_name, $middle_name, $last_name, $course, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username,$IDNumber, $status);
		if($course == TRUE){
