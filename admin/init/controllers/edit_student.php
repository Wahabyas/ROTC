<?php
  require_once "../model/class_model.php";
	...
	if(ISSET($_POST)){
		...
		$course = $conn->edit_student($first_name, $middle_name, $last_name, $course, $year_level, $date_ofbirth, $gender, $complete_address, $email_address, $mobile_number, $username, $password, $account_status,$Grad, $student_id);
		if($course == TRUE){
